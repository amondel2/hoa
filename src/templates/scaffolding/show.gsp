	...
	<body>
		...
		<div id="show-${domainClass.propertyName}" class="content scaffold-show" role="main">
			...
			<%  excludedProps = Event.allEvents.toList() << 'id' << 'version'
				...
				<tr>
         				<td><g:message code="${domainClass.propertyName}.${p.name}.label" default="${p.naturalName}" />
         				</td><td>
					<%  if (p.isEnum()) { %>
			...
			<g:form url="[resource:${propertyName}, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="btn btn-primary btn-sm active" resource="\${${propertyName}}" action="edit" ><g:message code="default.button.edit.label" default="Edit" /></g:link>

...
<html>
    ...
    <body>
        <a href="#create-meetingMinutes" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-meetingMinutes" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.meetingMinutes}" method="POST">
                <fieldset class="form">
